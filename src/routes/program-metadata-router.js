 ...
 */
router.get("/", (req, res) => res.send("This is the program metadata API endpoint!"))
 ...
 * @example
 * // Example of request
 * GET /api/program-metadata/tv-show/joker
 *
 * // Example of response
 * {
 *   "data": {
...
/**
 * Get recommendations for a tv-show given its id.
 * @name TvShowRecommendations
 * @route {GET} /api/program-metadata/tv-show/recommendations/:id
 * @routeparam {number} :id - The id of the tv-show
 * @memberof API.ProgramMetadata
 * @example
 * // Example of request
...
/**
 * Get recommendations for a movie given its id.
 * @name MovieRecommendations
 * @route {GET} /api/program-metadata/movie/recommendations/:id
 * @routeparam {number} :id - The id of the movie
 * @memberof API.ProgramMetadata
 * @example
 * // Example of request
